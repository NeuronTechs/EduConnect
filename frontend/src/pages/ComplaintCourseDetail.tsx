import { Breadcrumbs, Option, Select, Spinner } from "@material-tailwind/react";
      ...
      <div className="flex h-full">
        <div className="bg-white w-[70%] h-auto rounded-xl ,x">
          <div className="flex justify-between items-center mx-3 my-5">
            <p>
              Complaint-ID:{" "}
              <span className="text-red-500">{complaint?.complaint_id}</span>
            </p>
          ...
          <div className="mx-1 my-3 relative">
            ...
            <div className="mx-3">
              ...
              <div className="w-full my-3">
                <Select className="w-full" label="Lựa chọn hướng giải quyết">
                  <Option>Ẩn khóa học</Option>
