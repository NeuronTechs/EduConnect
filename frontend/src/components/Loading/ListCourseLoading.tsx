...
const CardCourseLoading = (): React.ReactElement => {
  return (
    <div
      role="status"
      className={` w-full px-2 pb-3 pt-2 bg-white border-gray-200 rounded-xl animate-pulse dark:border-gray-700 `}
    >
      ...
      <div className="flex items-center justify-end">
        <div className="h-10 min-w-[100px] bg-gray-200 rounded-full dark:bg-gray-700 mt-3"></div>
      </div>
